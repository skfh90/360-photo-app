...
if not exist "offline-gradle-8.13.7z.001" (
  echo Missing offline-gradle-8.13.7z.001
  exit /b 1
)
...
if "%SEVEN%"=="" (
  echo 7-Zip is required to unpack Gradle 8.13 and this project's caches.
  echo Install it from https://www.7-zip.org/ then re-run this script.
  exit /b 1
)

echo Extracting Gradle 8.13 and project caches into offline\ ...
"%SEVEN%" x -y -o. "offline-gradle-8.13.7z.001"
